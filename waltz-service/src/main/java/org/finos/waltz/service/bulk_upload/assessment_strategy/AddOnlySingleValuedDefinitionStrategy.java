...
public class AddOnlySingleValuedDefinitionStrategy implements AssessmentStrategy {
    ...
    public BulkChangeStatistics apply(DSLContext tx,
        ...
        DiffResult<Tuple3<Long, Long, String>> diffResult = DiffResult.mkDiff(
                existingRatings,
                requiredRatings,
                Tuple3::limit1, // key is entityId since this is an SVA
                Tuple3::equals); // diff any change to rating, comment and timestamp

        Collection<Tuple3<Long, Long, String>> toAdd = diffResult.otherOnly();
        Collection<Tuple3<Long, Long, String>> toUpdate = diffResult.intersection();
        ...
        Set<UpdateConditionStep<AssessmentRatingRecord>> updateStatements = map(
                toUpdate,
                d -> mkUpdateSingleValuedAssessmentStmt(
                        tx,
                        definition.id().get(),
                        d.v1,
                        d.v2,
    ...
    private UpdateConditionStep<AssessmentRatingRecord> mkUpdateSingleValuedAssessmentStmt(DSLContext tx,
                                                                                           Long defnId,
                                                                                           Long entityId,
                                                                                           Long ratingId,
                                                                                           String comment,
        ...
        return tx
                ...
                .set(ASSESSMENT_RATING.RATING_ID, ratingId)
