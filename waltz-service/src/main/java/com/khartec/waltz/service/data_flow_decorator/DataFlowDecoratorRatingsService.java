...
public class DataFlowRatingsService {
    ...
    public List<DataFlow> calculateRatings(List<DataFlow> flows) throws SQLException {
        ...
        List<Application> targetApps = lookupTargetApplications(flows);

        Map<Long, Application> targetAppsById = indexBy(a -> a.id().get(), targetApps);
        Set<Long> targetOuIds = map(targetApps, app -> app.organisationalUnitId());
    ...
    private List<Application> lookupTargetApplications(List<DataFlow> flows) throws SQLException {
