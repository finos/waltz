...
export function mkAuthoritativeSourceStore() {

    const update = (cmd) => {
        checkIsAuthSourceUpdateCommand(cmd);
        return remote
            .execute("PUT","api/authoritative-source", cmd)
    }
    ...
    const create = (cmd) => {
        ...
        return remote.execute("POST", "api/authoritative-source", cmd)
    }
...
export const authoritativeSourceStore = mkAuthoritativeSourceStore();
