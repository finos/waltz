...
import template from "./flow-classification-rules-summary-panel.html";
...
import {loadFlowClassificationRatings} from "../../flow-classification-utils";
            ...
            ratingsPromise
                .then(xs => vm.rowInfo = _
                    .map(
                        xs,
                        d => ({
                            flowClassification: d,
                            style: {
                                "border-radius": "2px",
                                "border-color": d.color,
                                "background-color": d.color,
                                "color": determineForegroundColor(d.color)
                            }
                        })));
...
export const id = "waltzFlowClassificationRulesSummaryPanel";
