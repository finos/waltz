...
<SubSection>
    <div slot="header">
        ...
        <span class="pull-right"><ChartInfo help="Change-log entries grouped by severity level."/></span>
    </div>
    <div slot="content">
