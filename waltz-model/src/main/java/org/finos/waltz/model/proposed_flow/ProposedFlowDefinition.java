...
public class ProposedFlowDefinition {
    ...
    public static class FlowAttributes {
        ...
        public void setBasisOffset(Integer basisOffset) {
    ...
    public ApplicationRef getSource() {
        return source;
    }

    public void setSource(ApplicationRef source) {
        this.source = source;
    }

    public ApplicationRef getTarget() {
        return target;
    }

    public void setTarget(ApplicationRef target) {
        this.target = target;
    }
    ...
    public Long getPhysicalFlowId() {
        return physicalFlowId;
    }

    public void setPhysicalFlowId(Long physicalFlowId) {
        this.physicalFlowId = physicalFlowId;
    }
    ...
    public List<Long> getDataTypeIds() {
        return dataTypeIds;
    }

    public void setDataTypeIds(List<Long> dataTypeIds) {
