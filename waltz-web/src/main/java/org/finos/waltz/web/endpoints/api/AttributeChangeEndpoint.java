...
public class AttributeChangeEndpoint implements Endpoint {
    ...
    private static final String BASE_URL = WebUtilities.mkPath("api", "attribute-change");
    ...
    public void register() {
        ...
        String findByChangeUnitIdPath = WebUtilities.mkPath(BASE_URL, "change-unit", ":id");
        ...
        EndpointUtilities.getForList(findByChangeUnitIdPath, findByChangeUnitIdRoute);
    }
