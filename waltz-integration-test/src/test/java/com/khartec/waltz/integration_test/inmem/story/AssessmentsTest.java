package com.khartec.waltz.integration_test.inmem.story;
...
import com.khartec.waltz.integration_test.inmem.helpers.ChangeLogHelper;
import com.khartec.waltz.integration_test.inmem.helpers.RatingSchemeHelper;
...
public class AssessmentsTest extends BaseInMemoryIntegrationTest {
    ...
    public void createUpdateAndRemoveSingleRating() {
        String user = mkUserId("user");
        String name = mkName("testAssessment");
        String role = mkName("testRole");
        ...
        EntityReference app1 = appHelper.createNewApp(mkName("app1"), ouIds.a);
        EntityReference app2 = appHelper.createNewApp(mkName("app2"), ouIds.b);
    ...
    private SchemeDetail createScheme() {
        long schemeId = schemeHelper.createEmptyRatingScheme(mkName("testScheme"));
